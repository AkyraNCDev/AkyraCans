...
let date = global.botdate
    ...
    let kurmatoken = global.db.data.users[m.sender].kurmatoken
    let cameltoken = global.db.data.users[m.sender].cameltoken
    ...
    let str = `
🚫EVENT 4 BELUM DIMULAI🚫
Dimulai 2 Mei ⏳

𝗥𝗔𝗠𝗔𝗗𝗛𝗔𝗡 𝗗𝗜𝗦𝗖𝗢𝗨𝗡𝗧

*Selama Periode Event Ini, Item-Item Dishop Mendapatkan Diskon Sebesar 30% Dan Khusus Untuk Limir Mendapatkan Diskon Sebesar 40%*


╭─────❒Your Token
├ ${cameltoken} Camel Token🐪
├ ${kurmatoken} Kurma Token🕊️
└───────────────>
