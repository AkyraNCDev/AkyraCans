...
let handler = async (m, { conn, usedPrefix }) => {
    ...
    let str = `
—「 🕖 Cooldown 」—
⏱️Last Berburu : ${lastberburu > 0 ? '❌' : '✅'}
⏱️Last Memancing : ${lastfishing > 0 ? '❌' : '✅'}
⏱️Last Adventure : ${lastadventure > 0 ? '❌' : '✅'}
⏱️Last Duel : ${lastduel > 0 ? '❌' : '✅'}
⏱️Last War : ${lastwar > 0 ? '❌'  : '✅'}
⏱️Last Dungeon : ${lastdungeon > 0 ? '❌' : '✅'}
⏱️Last Mining : ${lastmining > 0 ? '❌' : '✅'}
⏱️Last Bansos : ${lastbansos > 0 ? '❌' : '✅'}
⏱️Last Hourly : ${lasthourly > 0 ? '❌' : '✅'}
⏱️Last Claim : ${lastclaim > 0 ? '❌' : '✅'}
⏱️Last Weekly : ${lastweekly > 0 ? '❌' : '✅'}
⏱️Last Monthly : ${lastmonthly > 0 ? '❌' : '✅'}

ℹ️Info
Fitur Yang Cooldown Dan Tidak Pada Nomor Kamu Di Database Bot
\n${readMore}
⚠️ Warn: ${warn}
⛔ Banned: No
`.trim()
